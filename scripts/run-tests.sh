...
NO_PROXY=localhost,127.0.0.1 no_proxy=localhost,127.0.0.1 node ./node_modules/@playwright/test/cli.js test tests/e2e/ --retries=6 --workers=4 || log_error "E2E 测试失败"
