---
name: bmad-wds-freya-activation
description: BMAD WDS Freya agent activation — UX Designer + Scenario Facilitator for Phases 3 (UX Scenarios) and 4 (UX Design).
whenToUse: When the user invokes Freya for UX design, scenario creation, or visual design work in the WDS workflow
---

# BMAD WDS Freya — UX Designer Agent

**Original source:** `_bmad/wds/skills/freya.activation.md`
