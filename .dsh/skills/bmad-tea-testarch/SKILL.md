...
description: BMAD TEA (Test Architect) step-file architecture overview — tri-modal (create, edit, validate) test workflow patterns for strict LLM compliance.
whenToUse: When working with BMAD TEA test architecture workflows, understanding step-file patterns, or configuring test workflows
---

# BMAD TEA — Test Architect Step-File Architecture

**Original source:** `_bmad/tea/workflows/testarch/README.md`
