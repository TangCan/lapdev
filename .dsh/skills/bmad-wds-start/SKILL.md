---
name: bmad-wds-start
description: BMAD WDS /start session resume skill — loads project index, session state, and resumes the Web Design System workflow. Works for any agent (saga, freya, mimir).
whenToUse: When resuming a WDS workflow session in the BMAD framework, or when the user says "/start"
---

# BMAD WDS /start — Session Resume Skill

**Original source:** `_bmad/wds/skills/start.md`
