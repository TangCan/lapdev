---
name: bmad-wds-git-standards
description: BMAD Whiteport Git standards — Conventional Commits, branching rules, and commit frequency for all WDS agents.
whenToUse: When committing code, creating branches, or reviewing git workflows within the BMAD WDS framework
---

# BMAD WDS Git — Whiteport Standard

**Original source:** `_bmad/wds/skills/shared/git.md`
