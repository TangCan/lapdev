---
name: bmad-wds-agent-contracts
description: BMAD WDS Agent Contracts — defines what each agent owns, what they do NOT own, and how they hand off to each other. Rules are non-negotiable.
whenToUse: When coordinating between WDS agents (saga, freya, mimir), or when an agent asks about work outside its domain
---

# BMAD WDS — Agent Contracts

**Original source:** `_bmad/wds/data/agent-contracts.md`
