---
name: bmad-wds-handoff
description: BMAD WDS /handoff cross-agent handoff skill — passes a specific task or artifact to another WDS agent (saga, freya, mimir). This is NOT a session wrap.
whenToUse: When transferring a specific task to another BMAD WDS agent, e.g. strategy done → hand off to Freya for design
---

# BMAD WDS /handoff — Cross-Agent Handoff

**Original source:** `_bmad/wds/skills/handoff.md`
