---
name: bmad-wds-wrap
description: BMAD WDS /wrap session wrap skill — saves session state, updates project index, and optionally writes a handoff to another agent. Works for saga, freya, mimir.
whenToUse: When wrapping up a WDS workflow session, saving progress, or handing off work to another BMAD agent
---

# BMAD WDS /wrap — Session Wrap Skill

**Original source:** `_bmad/wds/skills/wrap.md`
