---
name: bmad-wds-shared-activation
description: BMAD WDS Shared Activation Steps — common startup sequence for all WDS agents (Saga, Freya, Mimir). Covers sync, state, scan, select, and brownfield detection.
whenToUse: When initializing any WDS agent, understanding the activation sequence, or troubleshooting agent startup
---

# BMAD WDS — Shared Activation Steps

**Original source:** `_bmad/wds/data/shared-activation.md`
