---
name: bmad-wds-glossary
description: BMAD WDS Glossary — locked terminology for all WDS agents. One definition per term. Defines phases, output folders, artifacts, patterns, and model selection.
whenToUse: When needing canonical WDS terminology, phase definitions, artifact paths, or model selection guidance
---

# BMAD WDS — Glossary

**Original source:** `_bmad/wds/data/wds-glossary.md`
