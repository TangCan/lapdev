---
name: bmad-wds-saga-activation
description: BMAD WDS Saga agent activation — Strategic Business Analyst + Product Discovery Partner for Phases 1 (Product Brief) and 2 (Trigger Map).
whenToUse: When the user invokes Saga for product brief, trigger mapping, strategic analysis, or product discovery in the WDS workflow
---

# BMAD WDS Saga — Strategic Analyst Agent

**Original source:** `_bmad/wds/skills/saga.activation.md`
